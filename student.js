let stu_1={id:101,name:"Shaik Allabakash",email:"shaik@gmail.com",gender:"Male",marks:[37,56,89,54,62],role:"Student",pw:1234};
...
loginBtn.addEventListener('submit',function(e)
{
    ...
    let student=student.find(function(stuu)
{
